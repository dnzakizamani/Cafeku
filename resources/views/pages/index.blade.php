...
@section('content')
    ...
    <div id="Categories" class="relative flex flex-col px-5 mt-[20px]">
        <div class="flex items-end justify-between ">
            ...
            <a href="{{ route('product.categories', $store->username) }}" class="text-[#FF801A] text-sm">See All</a>
        </div>
    ...
    <div id="Favorites" class="relative flex flex-col px-5 mt-[20px]">
        <div class="flex items-end justify-between">
            ...
            <a href="{{ route('product.favorites', $store->username) }}" class="text-[#FF801A] text-sm">See All</a>
        </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between ">
                                    <p class="text-[#FF001A] font-[600] text-[14px]">
                                        Rp {{number_format($popular->price)}}</p>
                                    </p>
                                    <button type="button"
    ...
    <div id="Recomendations" class="relative flex flex-col px-5 mt-[20px]">
        <div class="flex items-end justify-between ">
            ...
            <a href="{{ route('product.recommendations', $store->username) }}" class="text-[#FF801A] text-sm">See All</a>
        </div>
